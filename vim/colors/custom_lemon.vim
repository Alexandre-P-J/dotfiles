...
" Adventurous Theme + Modifications
...
let g:colors_name = "custom_lemon"
...
hi Pmenu ctermfg=White ctermbg=238 cterm=NONE guifg=White guibg=gray5 gui=NONE
...
hi Type ctermfg=NONE ctermbg=NONE cterm=NONE guifg=DodgerBlue2 guibg=NONE gui=NONE
...
" => CXX semantic highlight (clangd + vim-lsp-cxx-highlight)
hi LspCxxHlSkippedRegion guifg=Blue
hi LspCxxHlSkippedRegionBeginEnd guifg=White
hi LspCxxHlGroupEnumConstant guifg=#AD7FA8
hi LspCxxHlGroupNamespace guifg=#BBBB00
hi LspCxxHlGroupMemberVariable guifg=LightSkyBlue
hi LspCxxHlSymUnknown guifg=White
hi LspCxxHlSymClass guifg=SeaGreen3
hi LspCxxHlSymStruct guifg=SeaGreen3
hi LspCxxHlSymEnum guifg=SeaGreen3
hi LspCxxHlSymTypeAlias guifg=SeaGreen3
hi LspCxxHlSymTypeParameter guifg=SeaGreen3
hi LspCxxHlSymFunction guifg=khaki1
hi LspCxxHlSymMethod guifg=khaki1
hi LspCxxHlSymStaticMethod guifg=khaki1
hi LspCxxHlSymConstructor guifg=khaki1
hi LspCxxHlSymEnumMember guifg=MediumPurple2
hi LspCxxHlSymMacro guifg=RoyalBlue1
hi LspCxxHlSymNamespace guifg=SeaGreen4
hi LspCxxHlSymVariable guifg=LightSkyBlue
hi LspCxxHlSymParameter guifg=LightSkyBlue
hi LspCxxHlSymField guifg=LightSkyBlue
hi LspCxxHlSymUnknownStaticField guifg=White
hi LspCxxHlSymPrimitive guifg=SeaGreen3
hi LspCxxHlSymTypedef guifg=SeaGreen3
hi LspCxxHlSymTemplateParameter guifg=SeaGreen3
hi LspCxxHlSymEnumConstant guifg=MediumPurple2
hi LspCxxHlSymDependentType guifg=SeaGreen3
hi LspCxxHlSymDependentName guifg=LightSkyBlue
hi LspCxxHlSymConcept guifg=SeaGreen3
